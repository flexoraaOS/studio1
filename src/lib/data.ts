import type { Trade, Kpi, ChartData, RollingMetric, StrategyContribution, PnlCalendarData, ExpectancyData, TimeOfDayData, DailyReturn, FactorReturns, MonteCarloData, RollingBeta, CohortDataPoint, HistoricalEquityPoint } from './types';
...
export const mockTrades: Trade[] = [
  ...
  { id: 'A001', entryTime: '2023-11-03 09:30', exitTime: '2023-11-03 09:31', symbol: 'NIFTY50', direction: 'Long', size: 500, entryPrice: 19200, exitPrice: 19100, realizedPnl: -50000.00, pnlPercent: -0.52, currency: 'INR', strategy: 'Scalping', status: 'Closed', entryDate: '2023-11-03T09:30:00Z', exitDate: '2023-11-03T09:31:00Z', slippage: 2.5, durationSeconds: 60 },
  { id: 'A002', entryTime: '2023-11-03 10:00', exitTime: '2023-11-03 15:00', symbol: 'AMZN', direction: 'Long', size: 1000, entryPrice: 140.00, exitPrice: 139.50, realizedPnl: -500.00, pnlPercent: -0.36, currency: 'USD', strategy: 'Day-Trade', status: 'Closed', entryDate: '2023-11-03T10:00:00Z', exitDate: '2023-11-03T15:00:00Z', slippage: 0.50, durationSeconds: 18000 },
  { id: 'A003', entryTime: '2023-11-04 14:00', exitTime: '2023-11-04 14:00', symbol: 'MSFT', direction: 'Short', size: 5, entryPrice: 350, exitPrice: 340, realizedPnl: 50.00, pnlPercent: 2.85, currency: 'USD', strategy: 'Momentum', status: 'Closed', entryDate: '2023-11-04T14:00:00Z', exitDate: '2023-11-04T14:00:00Z', slippage: 0.02, durationSeconds: 1 },
];
